...
def store_chunks_in_chroma(
    ...
    collection_name: str = "judgments_chroma_testing_BAAI",
    batch_size: int = 250,
    ...
    print(f"Connecting to remote ChromaDB at http://{host}:{port}...")
    # Use HttpClient to connect to a running Chroma server
